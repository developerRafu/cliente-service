...
public enum LogEnum {
  ...
  GET_MUNCIPIOS_LOCALIDADE_SERVICE_REQUEST(
      "Get Municipios Localidade Service Request | EstadoId: %s"),
  GET_MUNICIPIOS_LOCALIDADE_SERVICE_RESPONSE(
      "Get Municipios Localidade Service Response | Response: %s"),
