...
class LocalidadeServiceTest {
    ...
    void shouldReturnEstados() {
        when(client.getEstados()).thenReturn(List.of(EstadoResponseMockBuilder.getBuilder().defaultValues().build()));
    ...
    void shouldReturnMunicipios() {
        when(client.getMunicipios(any())).thenReturn(List.of(MunicipioResponseMockBuilder.getBuilder().defaultValues().build()));
