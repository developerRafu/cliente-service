...
class EnderecoControllerTest {
    ...
    void shouldReturnCep() {
        when(service.findCep(anyString())).thenReturn(ViaCepResponseMockBuilder.getBuilder().defaultValues().build());
    ...
    void ShouldReturnEstados() {
        when(service.getEstados()).thenReturn(List.of(EstadoResponseMockBuilder.getBuilder().defaultValues().build(), EstadoResponseMockBuilder.getBuilder().defaultValues().withUF("RJ").build(), EstadoResponseMockBuilder.getBuilder().defaultValues().withUF("PA").build()));
    ...
    void ShouldReturnMunicipios() {
        when(service.getMunicipios(any())).thenReturn(List.of(MunicipioResponseMockBuilder.getBuilder().defaultValues().build()));
    ...
    void shouldSaveEndereco() {
        when(service.saveRequest(any())).thenReturn(EnderecoMockBuilder.getBuilder().defaultValues().build());
        final var result = controller.upsert(EnderecoRequestMockBuilder.getBuilder().defaultValues().build());
